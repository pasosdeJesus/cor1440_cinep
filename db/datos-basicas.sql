...
------ Plan trienal
      ...
      INSERT INTO public.cor1440_gen_tipoindicador (id, nombre, medircon, espcampos, espvaloresomision, espvalidaciones, esptipometa, espfuncionmedir) VALUES (22, 'E3I2', 2, '(1) Actor social que formula política pública, (2) Nombre de la política pública', '', 'El actor social debe formular políticas públicas (añadir a tipología de Sectores sociales)', 'Número de políticas públicas', 'Cuenta de nombres de políticas públicas en efectos con este indicador');

      INSERT INTO public.cor1440_gen_indicadorpf (id, proyectofinanciero_id, resultadopf_id, numero, indicador, tipoindicador_id, fechacreacion, created_at, updated_at) VALUES (18, 18, 18, 'E1I1', 'A 2022, Cinep/PPP ha propiciado al menos diez  escenarios de diálogo, en los que participen  actores (institucionalidad publica, sector privado, organizaciones sociales) implicados en los conflictos de los territorios.', 18);
      INSERT INTO public.cor1440_gen_indicadorpf (id, proyectofinanciero_id, resultadopf_id, numero, indicador, tipoindicador_id, fechacreacion, created_at, updated_at) VALUES (19, 18, 18, 'E1I2', 'En tres de las regiones donde Cinep/PPP trabaja, las mujeres y sus organizaciones han consolidado iniciativas con enfoque de género y fortalecen sus capacidades ciudadanas para la incidencia.', 19);
      ...
      INSERT INTO public.cor1440_gen_indicadorpf (id, proyectofinanciero_id, resultadopf_id, numero, indicador, tipoindicador_id, fechacreacion, created_at, updated_at) VALUES (21, 18, 20, 'E3I1', 'Para 2022 organizaciones y comunidades acompañadas por Cinep/PPP hacen parte de 15 mecanismos de interlocución y espacios de incidencia con actores que formulan políticas públicas.', 21);
      INSERT INTO public.cor1440_gen_indicadorpf (id, proyectofinanciero_id, resultadopf_id, numero, indicador, tipoindicador_id, fechacreacion, created_at, updated_at) VALUES (22, 18, 20, 'E3I2', 'Para el 2022 al menos seis políticas públicas locales están formuladas y se implementan con el enfoque territorial, de género y de derechos aportado por Cinep/PPP.', 22);
