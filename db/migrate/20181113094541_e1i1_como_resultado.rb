  ...
  def up
    execute <<-SQL
      ...
      INSERT INTO cor1440_gen_campoact (id, actividadtipo_id,
        ...
        VALUES (16, 83, '¿Es propiciado por CINEP/PPP?', '', 4);
      INSERT INTO cor1440_gen_campoact (id, actividadtipo_id,
        nombrecampo, ayudauso, tipo) 
        VALUES (17, 83, '¿Se creó para tratar un conflicto?', '', 4);
      INSERT INTO cor1440_gen_campoact (id, actividadtipo_id,
        nombrecampo, ayudauso, tipo) 
        VALUES (18, 83, '¿Participa más de un sector?', '', 4);
      INSERT INTO cor1440_gen_campoact (id, actividadtipo_id,
        nombrecampo, ayudauso, tipo) 
        VALUES (19, 83, '¿Se mantiene por lo menos dos veces?', '', 4);
