...
COMMENT ON TABLE sip_grupoper IS 'Creado por sip en cor1440cinep_desarrollo';
...
CREATE UNIQUE INDEX cor1440_gen_actividad_proyectofinanciero_idx ON cor1440_gen_actividad_proyectofinanciero USING btree (actividad_id, proyectofinanciero_id);
...
ALTER TABLE ONLY efecto
    ADD CONSTRAINT fk_rails_f1989d21d0 FOREIGN KEY (registradopor_id) REFERENCES usuario(id);
